---
title: "Introduction to Creative Coding with p5.js and Three.js"
description: "A brief introduction to creative coding with JavaScript libraries p5.js and Three.js, including generative code samples to help you get started."
...
# What is p5.js? A Digital Canvas

**p5.js** is a JavaScript library that makes it easy to create interactive graphics and animations in a web browser. It provides a simple set of functions for drawing shapes, handling user input, and creating generative art. It's a great tool for artists, designers, and developers interested in creative coding.

You can experiment with p5.js in its online editor: [https://editor.p5js.org/](https://editor.p5js.org/)

![p5js output 1](https://pantaleone-net.s3.us-west-1.amazonaws.com/blog-images/p5js1.png)

**Here is a p5.js code sample to get you started:**
