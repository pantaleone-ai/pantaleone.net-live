...
date: "2025-8-8"
category: "Code"
tags: ["gpt5", "system prompt", "llm reasoning"]
seo: ["GPT-5 system prompt", "AI assistant behavior", "LLM prompt engineering", "tool use guidelines", "safety guardrails", "prompt template", "adapt prompts to other LLMs", "middleware enforcement", "structured outputs", "AI UX best practices"]
---
